...
def setup_keepalive_worker(api_token: str, account_id: str, subdomain: str) -> None:
    # Keep-alive pinging is OFF by default. Hugging Face Spaces are intended
    # to sleep after a period of inactivity, and automated keep-awake pings
    # can put your account at risk of suspension. Enable only if you fully
